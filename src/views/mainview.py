...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1321, 719)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(MainWindow.sizePolicy().hasHeightForWidth())
        MainWindow.setSizePolicy(sizePolicy)
        MainWindow.setMinimumSize(QtCore.QSize(1321, 719))
        MainWindow.setMaximumSize(QtCore.QSize(1321, 719))
        self.centralwidget = QtWidgets.QWidget(parent=MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.Iterations = QtWidgets.QPlainTextEdit(parent=self.centralwidget)
        self.Iterations.setGeometry(QtCore.QRect(10, 46, 300, 541))
        ...
        self.Iterations.setLineWrapMode(QtWidgets.QPlainTextEdit.LineWrapMode.NoWrap)
        ...
        self.ExecuteButton.setGeometry(QtCore.QRect(10, 669, 85, 40))
        ...
        self.SpecificMethod.setGeometry(QtCore.QRect(10, 10, 300, 30))
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(320, 10, 711, 701))
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(1060, 10, 251, 701))
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(10, 601, 291, 62))
        ...
        self.Function = QtWidgets.QLineEdit(parent=self.layoutWidget1)
        font = QtGui.QFont()
        font.setPointSize(12)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Function.setText(_translate("MainWindow", "2*x**2 + x * y + y ** 2"))
